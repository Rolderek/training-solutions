...
public class Site {
    ...
    private int side;
    private int siteLong;
    private Fence fenceType;

    public Site(int side, int siteLong, Fence fenceType) {
        this.side = side;
    ...
    public static void main(String[] args) {
         Site newSite = new Site(0, 12, Fence.PERFECT);
         Site secondSite = new Site(1, 9, Fence.NO_FENCE);
         Site thirdSite = new Site(0, 7, Fence.NEED_UPGRADE);
        System.out.println(newSite.getSide() +  " " + newSite.getSiteLong() + " " + newSite.getFenceType());
        System.out.println(secondSite.getSide() +  " " + secondSite.getSiteLong() + " " + secondSite.getFenceType());
        System.out.println(thirdSite.getSide() +  " " + thirdSite.getSiteLong() + " " + thirdSite.getFenceType());
